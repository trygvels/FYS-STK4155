...
def load_mnist(conf, data_dir="data/mnist", devel_size=10000):
    """
    ...
    if conf["network_type"] == "DNN":
        ...
        #  (height_x, width_x, channels_x, batch_size)= (batch_size, channels_x, height_x, width_x)
        X_train = np.transpose(X_train, (3, 2, 0, 1))
        X_devel = np.transpose(X_devel, (3, 2, 0, 1))
...
def load_cifar10(conf, data_dir="data/cifar10", devel_size=10000):
    """
